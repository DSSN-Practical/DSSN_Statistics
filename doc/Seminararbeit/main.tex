...
%Erweiterung des Web
%Verwendung hoch strukturierter Daten im Gegensatz zu unstrukturierten oder Semi-Strukturierten Daten
%Verweis w3c Quelle
%Technologiestack, davon sind triplestores besonders interessant
...
%speicherung, editieren suchen von Datensätzen im Graphen, optimiert auf triple/quadrupel struktur
- Apache Jena
- Virtuoso
...
\cite{iso}
%Statistik im Netz
%baut auf blablubb auf, folgende Grafik zu sehen
